...
const routes: Routes = [
  ...
  {path: 'register', component: PageRegisterComponent, canActivate: [AuthService]},
  {path: 'login', component: PageLoginComponent, canActivate: [AuthService]},
  {path: 'feed', component: PageFeedComponent, canActivate: [AuthService],
  data: {loggedIn: true}},
  {path: 'profile/:userid', component: PageProfileComponent, canActivate: [AuthService], data: {loggedIn: true}},
  {
    path: 'messages',
